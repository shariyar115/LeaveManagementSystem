    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Angelina" });

            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "Id", "DefaultDays", "IsAccrued", "Name" },
                values: new object[,]
                {
                    { 1, 10, true, "Casual Leave" },
                    { 2, 7, false, "Sick Leave" },
                    { 3, 15, true, "Annual Leave" },
                    { 4, 90, false, "Maternity Leave" }
                });
